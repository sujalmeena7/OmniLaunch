  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <LogIn size={24} style={{ color: "#1e293b", transform: "translateX(2px)" }} />
        </div>

        <h1 style={{ fontSize: "24px", fontWeight: 800, color: "#1e293b", marginBottom: "8px" }}>
          Sign in with email
        </h1>
        <p style={{ fontSize: "14px", color: "#64748b", marginBottom: "40px", lineHeight: 1.5, maxWidth: "280px" }}>
        ...
        <form onSubmit={handleLogin} style={{ width: "100%", display: "flex", flexDirection: "column", gap: "12px" }}>
          ...
          <div style={{ position: "relative" }}>
            ...
            />
            <EyeOff size={16} style={{ position: "absolute", right: "18px", top: "50%", transform: "translateY(-50%)", color: "#94a3b8", cursor: "pointer" }} />
          </div>

          <div style={{ textAlign: "right", marginTop: "2px" }}>
            <button
              type="button"
              style={{ background: "none", border: "none", fontSize: "12px", color: "#64748b", fontWeight: 600, cursor: "pointer" }}
            >
              Forgot password?
            </button>
          </div>
