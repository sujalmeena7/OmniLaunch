...
import { Mail, Lock, User, EyeOff, LogIn } from "lucide-react";
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        padding: "24px",
        background: "linear-gradient(135deg, #e8ecf4 0%, #dfe6f0 50%, #d4dce8 100%)",
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSignup} style={{ width: "100%", display: "flex", flexDirection: "column", gap: "10px" }}>
          <div style={{ position: "relative" }}>
            <User size={16} style={{ position: "absolute", left: "16px", top: "50%", transform: "translateY(-50%)", color: "#8a93a1" }} />
            <input
              type="text"
              value={displayName}
